...
export const coffeeOptions = [
    ...
    { "name": `Black Coffee (${ozToMl(8)}ml)`, "caffeine": 95 },
    { "name": `Iced Coffee (${ozToMl(8)}ml)`, "caffeine": 90 },
    { "name": `Cold Brew (${ozToMl(12)}ml)`, "caffeine": 155 },
    { "name": `Nitro Cold Brew (${ozToMl(12)}ml)`, "caffeine": 215 },
    { "name": `Drip Coffee (${ozToMl(12)}ml)`, "caffeine": 120 },
    ...
    { "name": `Monster Energy (${ozToMl(16)}ml)`, "caffeine": 160 },
    { "name": `Red Bull (${ozToMl(8.4)}ml)`, "caffeine": 80 },
    { "name": `Rockstar Energy (${ozToMl(16)}ml)`, "caffeine": 160 },
    { "name": `Bang Energy (${ozToMl(16)}ml)`, "caffeine": 300 },
    { "name": `Celsius Energy Drink (${ozToMl(12)}ml)`, "caffeine": 200 },
    { "name": `5-hour Energy (${ozToMl(2)}ml)`, "caffeine": 200 },
    { "name": `NOS Energy Drink (${ozToMl(16)}ml)`, "caffeine": 160 },
    { "name": `Reign Energy Drink (${ozToMl(16)}ml)`, "caffeine": 300 },
    { "name": `Starbucks Doubleshot (${ozToMl(6.5)}ml)`, "caffeine": 135 },
    { "name": `Monster Java (${ozToMl(15)}ml)`, "caffeine": 188 },
    { "name": `AMP Energy Drink (${ozToMl(16)}ml)`, "caffeine": 142 },
