  ...
  return (
    <>
      <h1>
        ...
        <abbr title="An enthusiast or devotee of something">Fiends</abbr>!
      </h1>
      <div className="benefits-list">
        <h3 className="font-bolder">
          Try <span className="text-gradient">Caffeinator</span> and start...
        </h3>
      ...
      <div className="card info-card">
        ...
        <p>
          ...
          coffee or an energy drink with 200 mg of caffeine, 5 hours later,
          you&apos;ll still have about 100 mg of caffeine in your system.
        </p>
      </div>
    </>
  );
